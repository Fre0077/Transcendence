...
// export function createPlayerSelectDiv(cb: (players: PlayerData[]) => void): HTMLElement
// {
...
// 	div.innerHTML = /* html */`
// 		<div class="w-full max-w-md rounded-xl bg-slate-900 border border-white/10 p-6 space-y-4">
...
// 				<button
// 					id="finish-btn"
// 					class="flex-1 rounded-md bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-semibold py-2 transition">
// 					Start Tournament
// 				</button>
// 			</div>
...
// 	const usernameInput = div.querySelector('#player-username') as HTMLInputElement;
// 	const phraseInput = div.querySelector('#player-phrase') as HTMLInputElement;
// 	const iconBtn = div.querySelector('#icon-picker-btn') as HTMLButtonElement;
...
// 		iconBtn.textContent = `Icon: ${selectedIcon}`;
// 		picker.classList.add('hidden');
// 	};

// 	(div.querySelector('#add-player-btn') as HTMLButtonElement).onclick = () => {
...
// 	(div.querySelector('#finish-btn') as HTMLButtonElement).onclick = () => {
// 		if (!players.length) {
// 			errorMsg.textContent = 'Add at least one player.';
// 			errorMsg.classList.remove('hidden');
// 			return;
// 		}
