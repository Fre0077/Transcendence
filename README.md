...
1) [x] [AUTH] Google login nn fa (error 500 che fa bocciare instant)
...
4) [x] [LOCAL] Local tournament needs a better emoji (crown)
...
15) [] [CHAT] se cambi usename nelle chat rimane quello vecchio e se pigi sul profilo nn lo carica
16) [] [CHAT] nelle nuove chat nn arrivano i messaggi (ancora)